...
import CardStarships from "../component/CardStarShip";
import CardDetailPlanet from "../component/CardDetailPlanet";
        ...
        <h1 className="mt-5 text-h1 ms-2">Characters</h1>
          ...
          <div className="col-12 d-flex max-height mb-5 mt-1">
            ...
            {store.planets.map((planet, index) => {
              return (
                <CardPlanet name={planet.name} uid={planet.uid} key={index} />
              );
            })}
          </div>
